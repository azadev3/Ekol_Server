...
router.post('/blogimage', checkUser, checkPermission('create_xebersekilleri'), uploadConfig.array('imgback'), async (req, res) => {
  try {
...
router.get('/blogimage', checkUser, checkPermission('list_xebersekilleri'), async (req, res) => {
  try {
...
router.put('/blogimage/:editid', checkUser, checkPermission('update_xebersekilleri'), uploadConfig.array('newImages'), async (req, res) => {
  try {
    const { editid } = req.params;
...
router.delete('/blogimage/:deleteid', checkUser, checkPermission('delete_xebersekilleri'), async (req, res) => {
  try {
